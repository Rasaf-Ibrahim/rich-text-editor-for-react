...
>
> - Opt for `image_cloud` if you intend to upload images to a cloud platform like Cloudinary, which will provide a URL for the uploaded image. Please note that utilizing a cloud platform requires additional setup. You can find detailed setup guidance [here](/guide/upload-image-in-cloud).
...
The `customizeUI` prop allows you to customize the user interface of the toolbar and editor. Detailed information about this prop can be found on the [UI Customization](/guide/ui-customization) page.
